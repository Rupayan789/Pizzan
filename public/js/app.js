...
var adminbody = function adminbody(socket) {
  ...
  axios.get('/admin/order', {
    ...
    markup = getMarkup(orders); // console.log(markup)
...
var cardCounter = document.querySelector("#card-counter"); //hamburger animation
...
var alertSuccess = document.querySelector('#success-alert');

if (alertSuccess) {
  setTimeout(function () {
    return alertSuccess.remove();
  }, 2000);
} //status of order
...
if (hiddenInput) order = JSON.parse(hiddenInput.value); // console.log(order)

var allLists = document.querySelectorAll('.status_line');
...
var updateStatus = function updateStatus(order) {
  allLists.forEach(function (list) {
    ...
    if (status === order.status) {
      var small = document.createElement('small'); // small.innerText=order.updatedAt;
      ...
      while (temp.previousElementSibling) {
        ...
        if (temp.classList.contains('current')) temp.classList.remove('current');
...
var adminUrl = window.location.pathname;

if (adminUrl.includes('admin')) {
  _admin__WEBPACK_IMPORTED_MODULE_3___default()(socket);
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_2___default()().format('LT');
